...
from pages.history_page.chem_section.ChemHistoryItem import ChemHistoryItem

# managers the data and logic
class ChemHistoryModel:
    ...
    def add_item(self, item):
        ...
        self.history_items.append(ChemHistoryItem(jobNum, report, parameter, dilution, creationDate, status))
