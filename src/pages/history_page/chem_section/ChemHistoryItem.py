...
class ChemHistoryItem:
    ...
    def __eq__(self, other):
        # Ensure `remove()` knows what qualifies as an equal ChemHistoryItem
        if isinstance(other, ChemHistoryItem):
            return (
    ...
    def __repr__(self):
        return (f"ChemHistoryItem(jobNum={self.jobNum}, report='{self.report}', "
