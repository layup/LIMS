...
def createReportPage(self, jobNum = None, reportType = None, parameter = None, dilution =None, method2= None):
    ...
    if(sum(errorCheck) == 0):
        ...
        try:
            prepare_layout_config(self, self.reportType)
...
def prepare_layout_config(self, reportType):
    self.logger.info(f'Entering prepare_layout_config with parameter: reportType: {repr(reportType)}')
