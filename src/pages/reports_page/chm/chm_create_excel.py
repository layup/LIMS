...
def chm_create_excel(clientInfo, jobNum, authorsInfo, reportComment, sampleNames, sampleData, testInfo, unitType, recovery):
    logger.info(f'Entering chm_create_excel with parameters:')
