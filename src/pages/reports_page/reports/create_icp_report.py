...
from pages.reports_page.reports.report_utils import (
    formatReportTable, populateTableRow,
...
def icpReportHandler(self, elements, limits, totalSamples, reportNum):
    ...
    try:
        ...
        #        #icp_create_excel(clientInfo, sampleNames, authorsInfo, jobNum,  sampleData, testInfo, unitType, limitElements, limits, footerComment):
        filePath, fileName = icp_create_excel(self.clientInfo, self.sampleNames, authorsInfo, self.jobNum, sampleData, elementNames, unitType, elementNames, limits, footerComment)
