...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../assets/icon/search.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"} ")
        ...
        self.matrixType = QtWidgets.QComboBox(self.Body)
        self.matrixType.setMinimumSize(QtCore.QSize(200, 0))
        self.matrixType.setMaximumSize(QtCore.QSize(200, 16777215))
        self.matrixType.setObjectName("matrixType")
        self.matrixType.addItem("")
        self.matrixType.addItem("")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.matrixType)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.paramType)
        ...
        self.methodType = QtWidgets.QComboBox(self.Body)
        self.methodType.setMinimumSize(QtCore.QSize(200, 0))
        self.methodType.setMaximumSize(QtCore.QSize(200, 16777215))
        self.methodType.setObjectName("methodType")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.methodType)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.stdType)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.NextSection)
...
"}")
        ...
        self.tableView = QtWidgets.QTableView(self.icpDatabase)
        self.tableView.setGeometry(QtCore.QRect(170, 110, 256, 192))
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(10, 10, 181, 51))
        self.pushButton_7.setObjectName("pushButton_7")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.settingBody)
        self.lineEdit_2.setGeometry(QtCore.QRect(200, 20, 371, 21))
...
"")
        ...
        self.widget_11 = QtWidgets.QWidget(self.Header_2)
        self.widget_11.setObjectName("widget_11")
        self.formLayout_3 = QtWidgets.QFormLayout(self.widget_11)
...
"")
        ...
        self.GenerateReportBtn = QtWidgets.QPushButton(self.tabSectionContainer)
        self.GenerateReportBtn.setObjectName("GenerateReportBtn")
        self.horizontalLayout_4.addWidget(self.GenerateReportBtn)
...
"}")
        ...
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.dataEntryBody)
...
"")
        ...
        self.verticalLayout_13.addWidget(self.dataTable)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Matrix"))
        ...
        self.matrixType.setItemText(0, _translate("MainWindow", "test"))
        self.matrixType.setItemText(1, _translate("MainWindow", "test2"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "ICP Database"))
        self.pushButton_4.setText(_translate("MainWindow", "Define ICP Elements"))
        self.pushButton_5.setText(_translate("MainWindow", "Reports"))
        self.label_11.setText(_translate("MainWindow", "Settings"))
        self.pushButton_7.setText(_translate("MainWindow", "Data"))
        ...
        item.setText(_translate("MainWindow", "UnitType "))
        ...
        item.setText(_translate("MainWindow", "Ref Values "))
